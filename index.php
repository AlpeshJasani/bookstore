...
// 
    ...
    echo "<table style='width:20%; float:right; border:1px solid black'>";
    ...
    while($row = $result->fetch_assoc()){
    	...
    	echo "Total Price: ₹".$row['TotalPrice']."<hr style='margin:0.5px;'></td></tr>";
    	$total += $row['TotalPrice'];
    }
    echo "<tr><td style='text-align: right; padding:15px; background-color: #f2f2f2;''>";
    echo "Total: <b>₹".$total.".00</b><center><form action='checkout.php' method='post'><input class='button' type='submit' name='checkout' value='CHECKOUT'></form></center>";
    echo "</td></tr>";
	echo "</table>";
	echo '</blockquote>';
?>
